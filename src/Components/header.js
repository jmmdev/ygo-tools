...
const Header = ({navigation, title, goBackFunction, canSearch, inputSubmitFunction, inputPlaceHolder, onHideSearchFunction,
    ...
    }, [goBackFunction, navigation, onHideSearchFunction, search]);
    ...
    return (
        <View style={styles.header}>
            ...
            {!search &&
            <Text adjustsFontSizeToFit={true} style={inputStyles.headerText}>{title}</Text>
            }
            {search &&
            <View style={inputStyles.inputStyle}>
                ...
                selectionColor={'#ffffff68'} autoFocus={true} placeholderTextColor={'#fff4'} adjustsFontSizeToFit={true} placeholder={inputPlaceHolder} />
